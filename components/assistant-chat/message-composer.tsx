...
export function MessageComposer({assistantId,value,onChange,onSend,privateChannel=false,cloudPersisted=false}:{assistantId:string;value:string;onChange:(value:string)=>void;onSend:()=>void;privateChannel?:boolean;cloudPersisted?:boolean}){
