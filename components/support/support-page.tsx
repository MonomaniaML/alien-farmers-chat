...
import {MessageCircle,Info,ArrowUpRight,ArrowLeft} from 'lucide-react';
...
function SupportContent({initialTheme,tickets}:{initialTheme:'dark'|'light';tickets:boolean}){
 ...
 const entries:{title:string;description:string;href:string;icon:ReactNode}[]=[{title:'Live support',description:'Talk with our support team.',href:'/chat',icon:<MessageCircle/>},{title:'About us',description:'Get to know ALIEN FARMERS.',href:`${platformOrigins.website}/about`,icon:<Info/>}];
